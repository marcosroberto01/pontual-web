...
public class Tbbalancas implements Serializable {
    ...
    public Tbbalancas(Integer cdBalanca) {
        this.cdBalanca = cdBalanca;
    }

    public Tbbalancas(Integer cdBalanca, int cdClienteBalanca) {
        this.cdBalanca = cdBalanca;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Tbbalancas)) {
            return false;
        }
        Tbbalancas other = (Tbbalancas) object;
